...
import com.tcc.agronomia.domain.Arduino;
import com.tcc.agronomia.domain.ArduinoService;
import com.tcc.agronomia.domain.Usuario;
import com.tcc.agronomia.domain.UsuarioService;
...
public class ArduinoController {
    ...
    public String post(@RequestBody Arduino arduino){
        ...
        return "Usuario salvo com sucesso: "+ar.getId();
    }
